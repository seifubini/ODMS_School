    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="<?php echo e(url('/donations')); ?>" class="navbar-brand"><b>ODMS</b></a>
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown messages-menu">
              <!-- Menu toggle button -->
              <a href="<?php echo e(url('/chats')); ?>" class="dropdown-toggle" data-toggle="dropdown">
...
<?php /**PATH C:\Users\Creative\Desktop\ODMS\resources\views/layouts/header.blade.php ENDPATH**/ ?>