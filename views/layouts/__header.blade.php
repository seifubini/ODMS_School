...
<div class="row">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{ url('/donations')}}" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>OD</b>MS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>ODMS</b></span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="collapse navbar-collapse pull-left" id="navbar-collapse"> 
        <ul class="nav navbar-nav">
           <li class=""><a href="{{ url('/donations')}}">Advertisements <span class="sr-only">(current)</span></a></li>
            @if( Auth::user()->user_type != 'donee')
            <li><a href="{{ url('/donees')}}">Donees</a></li>
            @endif
