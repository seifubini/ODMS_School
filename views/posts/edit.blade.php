    ...
    <div class="row">
        <div class="col-lg-8 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('posts.index') }}" title="Go back"> <i class="fas fa-backward "></i> Index </a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="location" class="form-control" placeholder="{{ $post->location }}"
                        value="{{ $post->location }}">
                </div>
            </div>
